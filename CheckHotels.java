...
public class CheckHotels extends JFrame implements Runnable{
	...
	public void run() {
		String[] text = new String[] {"The Tajmahal Palace", "JW Marriott Hotel", "The Lalit New Delhi", "Royal Kalinga Cottages Manali, Affordable Cottage","Sun Park Resort","Namaste Inn Beas Valley","Hotel Sheela","Hotel The Royal Plaza","Hotel River View","Taj Palace"};
